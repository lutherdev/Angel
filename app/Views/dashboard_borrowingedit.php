                    ...
                    <form>
                        <div class="mb-6">
                            <label for="borrow_id" class="block text-gray-700 text-sm font-medium mb-2">
                                <i class="fas fa-hashtag mr-2 text-orange-600"></i>Borrow ID
                            </label>
                            <input 
                                type="text" 
                                name="borrow_id" 
                        ...
                        <div class="mb-6">
                            <label for="borrow_date" class="block text-gray-700 text-sm font-medium mb-2">
                                <i class="fas fa-calendar-alt mr-2 text-orange-600"></i>Borrow Date
                            </label>
                            <input 
                                type="date" 
                                name="borrow_date" 
                        ...
                        <div class="mb-6">
                            <label for="return_date" class="block text-gray-700 text-sm font-medium mb-2">
                                <i class="fas fa-calendar-check mr-2 text-orange-600"></i>Return Date
                            </label>
                            <input 
                                type="date" 
                                name="return_date" 
                        ...
                        <div class="mb-6">
                            <label for="status" class="block text-gray-700 text-sm font-medium mb-2">
                                <i class="fas fa-info-circle mr-2 text-orange-600"></i>Status
                            </label>
                            <select 
                                name="status" 
                                id="status" 
                        ...
                        <div class="flex justify-between items-center">
                            <a href="<?= base_url('/borrowings/view/B001') ?>" class="text-gray-600 hover:text-gray-800 font-medium flex items-center">
                                <i class="fas fa-eye mr-2"></i>
                                View Details
                            </a>
                            <button 
                                type="button" 
                                class="bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-lg font-medium flex items-center transition duration-200 shadow-md hover:shadow-lg"
